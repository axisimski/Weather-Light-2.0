...
public class getDataF extends AsyncTask<Void, Void, Void>{
    ...
    protected Void doInBackground(Void... voids)  {
        ...
        try {
            ...
            sizeofTemp= Jcur.getString("temp_f").length();
            currTemp=Jcur.getString("temp_f")+" F°\n"+"(Feels like "+Jcur.getString("feelslike_f")+" F°)";
            ...
            currentConditions="\n "+location+"\n\n   "+textCondition
                    +"\n"+"   High: " +JcurrDay.getString("maxtemp_f")+" F°\n"
                    +"   Low: "+JcurrDay.getString("mintemp_f")+" F°";
            ...
            day1=Jday1.getString("maxtemp_f")+" F°\n"+Jday1.getString("mintemp_f")+" F°";
            ...
            day2=Jday2.getString("maxtemp_f")+" F°\n"+Jday2.getString("mintemp_f")+" F°";
            ...
            day3=Jday3.getString("maxtemp_f")+" F°\n"+Jday3.getString("mintemp_f")+" F°";
            ...
            day4=Jday4.getString("maxtemp_f")+" F°\n"+Jday4.getString("mintemp_f")+" F°";
